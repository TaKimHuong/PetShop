        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
                ...
                <a onclick="return confirm('Bạn có chắc là muốn xóa mã giảm giá này không?')" href="{{URL::to('/xoa-ma-giam-gia/'.$cou->coupon_id)}}" class="active styling-edit" ui-toggle-class="">
